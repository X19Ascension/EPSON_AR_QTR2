...
public class TankEnemy : FSMBase
{
    ...
    void CheckIfInRange()
    {
        if (this.gameObject.GetComponent<Collider>().bounds.Intersects(m_TargetedEnemy.GetComponent<Collider>().bounds))
        {
            b_InRange = true;
        }
        else
